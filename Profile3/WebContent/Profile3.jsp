<%@page import="com.profile.Student"%> 
...
<a href="dummy.jsp"><button type="button" class="btn btn-block" id="ButtonOne">Profile</button></a>
...
<button type="button" class="btn  btn-block" id="ButtonFour">Feed</button>
</div>
...
<!--Card-->
  <div class="card testimonial-card mt-2 mb-3">
    ...
    <div class="card-body">
      <!-- Name -->
      <h4 class="card-title font-weight-bold" align="center"><%=s.getFirstName()%></h4>
      <hr>
      <!-- Quotation -->
      
      <div class="for-profile">Name<br/></div>
      <div class="for-roundcorners"><p class="RoundCorners" ><%=s.getFirstName()%>  <%=s.getLastName()%></p></div><br/>
      
      <div class="for-profile">Department <br/></div>
      <div class="for-roundcorners"><p class="RoundCorners" ><%=s.getDepartment()%> </p></div>
      
      <div class="for-profile">Class <br/></div>
      <div class="for-roundcorners"><p class="RoundCorners " ><%=s.getCls()%></p>
      </div><br/>
      
      <div class="for-profile">Year of Engineering<br/></div>
      <div class="for-roundcorners"><p class="RoundCorners" ><%=s.getYoe()%></p></div><br/>
